...
const CateringCard = () => {
  return (
    <div className="col-span-12 md:col-span-5 p-5 h-[50rem] md:h-[60rem] border-2 border-primary rounded-3xl">
      ...
      <div className="flex flex-col mb-6 p-4 rounded-3xl">
        ...
        />
        <div className="text-center text-3xl font-semibold p-4 md:pt-20 rounded-3xl">
          <Link href="tel:770-926-3446">
            <Button variant="outline" className="border-2 border-primary text-primary m-5 px-10 py-4 md:px-12 md:py-6 hover:bg-primary hover:text-white">
              Set up an event
            </Button>
          </Link>
          <Link href="#catering">
