...
const FoodContent = () => {
  const sections: Section[] = [
    ...
    {
      title: "Wrap Specials",
      sectionDescription: "Standard Wraps: Gyro, Chicken with Tzatziki, Chicken Shawarma, Falafel, Fish, Kufta, or Grilled Veggies. Premium Wraps: Beef Shawarma, Shrimp Wrap. Sides: Fries, Rice, or Salad Bar. All combos include a Fountain Drink.",
      menuItems: [
        ...
        { name: "Premium Wrap Combo", price: "$14.00", description: "Beef Shawarma or Shrimp wrap with choice of one side and Fountain Drink" },
        { name: "Premium Wrap Combo Deluxe", price: "$15.00", description: "Beef Shawarma or Shrimp wrap with choice of 2 sides and Fountain Drink" },
      ],
      variant: "left",
    },
    {
      ...
      menuItems: [
        { name: "Chicken Kabob", price: "$17.00", description: "Marinated chicken breast skewered and grilled" },
        { name: "Beef Kabob", price: "$19.00", description: "Marinated beef skewered and grilled" },
        { name: "Kufta Kabob", price: "$17.00", description: "Ground beef skewered and grilled" },
        { name: "Lamb Kabob", price: "$19.00", description: "Marinated lamb skewered and grilled" },
        { name: "Shrimp Kabob", price: "$17.00", description: "Marinated shrimp skewered and grilled"},
        { name: "Veggie Kabob", price: "$13.00", description: "Marinated veggies skewered and grilled" },
      ],
      variant: "left",
    },
    {
      ...
      menuItems: [
        ...
        { name: "Combo Platter", price: "$17.00", description: "Two types of meats which are Grilled Chicken, and Gyro this is served with house salad, Hummus, and Pita bread" },
        { name: "Ultimate Meat Platter", price: "$20.00", description: "Three types of meats which are Gyro, Grill Chicken, and kofta that is served with rice, hummus, and Pita bread" },
        { name: "Sahara Signature Dish", price: "$27.00", description: "Four types of meats which are gyro meat, grilled chicken, beef skewer, and a kofta skewer that is served with rice, house salad, hummus, and pita bread" },
      ],
      variant: "right",
    },
    {
      ...
      menuItems: [
        ...
        { name: "Beef Skewer", price: "$7.00", description: "" },
        { name: "Lamb Skewer", price: "$7.00", description: "" },
        { name: "Kufta Skewer", price: "$6.00", description: "" },
        { name: "Chicken Skewer", price: "$6.00", description: "" },
        { name: "Veggie Skewer", price: "$5.00", description: "" },
      ],
      variant: "left",
    },
    {
      ...
      menuItems: [
        ...
        { name: "Kids Chicken Tenders", price: "$9.00", description: "" },
        { name: "Shrimp Kabob", price: "$9.00", description: "" },
        { name: "Kids Chicken Kabob", price: "$9.00", description: "" },
        { name: "Kids Beef Kabob", price: "$10.00", description: "" },
        { name: "Kids Lamb Kabob", price: "$10.00", description: "" },
      ],
      variant: "right",
    },
    {
