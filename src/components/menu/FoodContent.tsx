...
const FoodContent = () => {
  const sections: Section[] = [
    ...
    {
      title: "Wrap Specials",
      sectionDescription: "The Choices of Wraps are Gyro, Chicken with tzatziki, Chicken Shawarma, Kofta, Falafel, Fish, or Grilled Veggies. The Choices of Sides are Fries, Rice, or Salad from the Salad Bar",
      menuItems: [
        { name: "Any Wrap with a choice of one side and Fountain Drink", price: "$11.00", description: "" },
        { name: "Any Wrap with a choice of 2 sides and a Fountain Drink", price: "$12.00", description: "" },
      ],
      variant: "left",
    },
    {
